...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print(" === List of Robots === ");
        robot.listRobots();

        System.out.print(" === List of Land Robots with Speed greater than 50km/hr === ");
        robot.filterByMaxSpeed(50).forEach(r -> System.out.print(r.getName() + " | " + r.getManufacturer()));

        System.out.println(" === List of Robots by Manufacturer === ");
        robot.filterByManufacturer("TESLA").forEach(r -> System.out.print(r.getName() + " | " + r.getManufacturer()));
    }
}
